...
const PlayXCoinMultiSigFactory = artifacts.require('PlayXCoinMultiSigWallet.sol');
...
contract("PlayXCoinMultiSigWallet", (accounts) => {
  ...
  it("Add a signer", async () => {
    ...
    assertNotRevert("signer1",() => walletInstance.requestTransferInPLX(user2, 1, 0, "test addsigner-1", {from: user1}));
    assertNotRevert("signer2",() => walletInstance.requestTransferInDennis(user2, 1, "test addsigner-2", {from: user1}));
